...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__profile_page__ = __webpack_require__(600);
...
ProfilePage = __decorate([
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-profile-page',template:/*ion-inline-start:"D:\Pawan\Project\ionic3-seed-jwt\src\pages\profile-page\profile-page.html"*/'\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>    \n\n    <ion-title>{{ \'page.profile\' | translate }}</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content>\n\n  <ion-card *ngIf="user">\n\n    \n\n    <ion-row>\n\n      <ion-col col-25>{{ \'label.name\' | translate }}:</ion-col>\n\n      <ion-col col-75>{{ user.name }}</ion-col>\n\n    </ion-row>\n\n    \n\n    <ion-row>\n\n      <ion-col col-25>{{ \'label.email\' | translate }}:</ion-col>\n\n      <ion-col col-75>{{ user.email }}</ion-col>\n\n    </ion-row>\n\n       \n\n  </ion-card>\n\n\n\n\n\n</ion-content>\n\n\n\n\n\n\n\n'/*ion-inline-end:"D:\Pawan\Project\ionic3-seed-jwt\src\pages\profile-page\profile-page.html"*/,
    }),
